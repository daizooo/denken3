...
| etheory | 電子理論 | 42 | **マッピング確定・未投入**（50枚実読／2問同居0・解答またがり4・捨て問4。Drive改名によりファイル名が不一致で取り込み不成立＝`docs/etheory-ecircuit-import-investigation.md`） |
| ecircuit | 電子回路 | 52 | **マッピング確定・未投入**（82枚実読／2問同居0・解答またがり17・捨て問6＋奥付1除外。理由は同上） |
