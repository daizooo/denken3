...
// 全59画像(newIMG_0478〜0537、0517欠番=内容連続)を実読し MASTER(MEAS_QUESTIONS 45問)と突合。
// 変則:
...
//  - 捨て問(問2,22,29,39,44,48)はマッピングに含めない（MASTER未登録）。
//      2問(0479+0480)・22問(0500+0501)・48問(0532+0533)は各2画像、29/39/44問は各1画像で除外。
//  - 問49,50,51（オシロスコープ）は捨て問リストに含まれないため MASTER に収録。
//      49問(0534)・50問(0535)は各1画像、51問(0536+0537)は見開き2画像で紐付け（画像未取込のため要確認）。
