...
export const R7_1: PaperDefinition = {
  ...
  questions: [
    ...
    { id: 'r7-1_a02', section: 'A', number: 2, imageFile: 'a02.png', questionStartPct: 18.10, answerYPct: 24.88, explanationEndPct: 74.19, topic: '直流機', parts: [{ correct: 2, points: 5 }] },
    ...
    { id: 'r7-1_a05', section: 'A', number: 5, imageFile: 'a05.png', questionStartPct: 23.13, answerYPct: 37.24, explanationEndPct: 67.51, topic: '同期機', parts: [{ correct: 3, points: 5 }] },
    ...
    { id: 'r7-1_a07', section: 'A', number: 7, imageFile: 'a07.png', questionStartPct: 16.85, answerYPct: 29.20, explanationEndPct: 76.37, topic: '電動機応用', parts: [{ correct: 3, points: 5 }] },
    { id: 'r7-1_a08', section: 'A', number: 8, imageFile: 'a08.png', questionStartPct: 16.67, answerYPct: 30.63, explanationEndPct: 76.73, topic: '電気機器', parts: [{ correct: 3, points: 5 }] },
