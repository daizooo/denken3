...
export const R6_1: PaperDefinition = {
  ...
  timeLimitMin: 90,
  questions: [
    { id: 'r6-1_a01', section: 'A', number: 1, imageFile: 'a01.png', questionStartPct: 18.55, answerYPct: 42.26, explanationEndPct: 75.65, topic: '電磁気', studyMode: 'calc', parts: [{ correct: 5, points: 5 }] },
    { id: 'r6-1_a02', section: 'A', number: 2, imageFile: 'a02.png', questionStartPct: 23.24, answerYPct: 30.66, explanationEndPct: 69.37, topic: '電磁気', studyMode: 'calc', parts: [{ correct: 4, points: 5 }] },
    { id: 'r6-1_a03', section: 'A', number: 3, imageFile: 'a03.png', questionStartPct: 18.73, answerYPct: 26.08, explanationEndPct: 75.21, topic: '電磁気', studyMode: 'calc', parts: [{ correct: 2, points: 5 }] },
    { id: 'r6-1_a04', section: 'A', number: 4, imageFile: 'a04.png', questionStartPct: 19.93, answerYPct: 35.56, explanationEndPct: 73.6, topic: '電磁気', studyMode: 'calc', parts: [{ correct: 2, points: 5 }] },
    { id: 'r6-1_a05', section: 'A', number: 5, imageFile: 'a05.png', questionStartPct: 10.41, answerYPct: 14.77, explanationEndPct: 86.84, topic: '電気回路', studyMode: 'calc', parts: [{ correct: 1, points: 5 }] },
    ...
    { id: 'r6-1_a08', section: 'A', number: 8, imageFile: 'a08.png', questionStartPct: 14.75, answerYPct: 25.33, explanationEndPct: 80.42, topic: '電気回路', studyMode: 'calc', parts: [{ correct: 3, points: 5 }] },
