...
export const R6_2: PaperDefinition = {
  ...
  questions: [
    ...
    { id: 'r6-2_a05', section: 'A', number: 5, imageFile: 'a05.png', questionStartPct: 15.54, answerYPct: 26.36, explanationEndPct: 78.74, topic: '電気回路', studyMode: 'calc', parts: [{ correct: 5, points: 5 }] },
    { id: 'r6-2_a06', section: 'A', number: 6, imageFile: 'a06.png', questionStartPct: 10.09, answerYPct: 17.25, explanationEndPct: 86.12, topic: '電気回路', studyMode: 'calc', parts: [{ correct: 4, points: 5 }] },
    { id: 'r6-2_a07', section: 'A', number: 7, imageFile: 'a07.png', questionStartPct: 21.51, answerYPct: 32.82, explanationEndPct: 70.57, topic: '電気回路', studyMode: 'calc', parts: [{ correct: 4, points: 5 }] },
    { id: 'r6-2_a08', section: 'A', number: 8, imageFile: 'a08.png', questionStartPct: 19.7, answerYPct: 36.69, explanationEndPct: 72.9, topic: '電気回路', studyMode: 'calc', parts: [{ correct: 3, points: 5 }] },
    { id: 'r6-2_a09', section: 'A', number: 9, imageFile: 'a09.png', questionStartPct: 17.23, answerYPct: 23.38, explanationEndPct: 76.44, topic: '電気回路', studyMode: 'calc', parts: [{ correct: 3, points: 5 }] },
    ...
    {
      id: 'r6-2_b15', section: 'B', number: 15, imageFile: 'b15.png', questionStartPct: 8.59, answerYPct: 17.65, explanationEndPct: 87.97, topic: '電気回路', studyMode: 'calc',
      parts: [{ label: '(a)', correct: 2, points: 5 }, { label: '(b)', correct: 2, points: 5 }],
    },
    {
      id: 'r6-2_b16', section: 'B', number: 16, imageFile: 'b16.png', questionStartPct: 14.55, answerYPct: 29.26, explanationEndPct: 79.63, topic: '電気及び電子計測', studyMode: 'calc',
      parts: [{ label: '(a)', correct: 3, points: 5 }, { label: '(b)', correct: 4, points: 5 }],
    },
    {
      id: 'r6-2_b17', section: 'B', number: 17, imageFile: 'b17.png', questionStartPct: 13.74, answerYPct: 29.87, explanationEndPct: 81.33, topic: '電磁気', selectable: true, studyMode: 'calc',
      parts: [{ label: '(a)', correct: 3, points: 5 }, { label: '(b)', correct: 2, points: 5 }],
    },
    {
      id: 'r6-2_b18', section: 'B', number: 18, imageFile: 'b18.png', questionStartPct: 13.08, answerYPct: 36.78, explanationEndPct: 81.57, topic: '電子理論', selectable: true, studyMode: 'calc',
