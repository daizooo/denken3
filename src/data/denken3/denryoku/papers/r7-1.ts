...
export const R7_1: PaperDefinition = {
  ...
  timeLimitMin: 90,
  questions: [
    { id: 'r7-1_a01', section: 'A', number: 1, imageFile: 'a01.png', questionStartPct: 14.7, answerYPct: 29.4, explanationEndPct: 80.7, topic: '水力', parts: [{ correct: 2, points: 5 }] },
    { id: 'r7-1_a02', section: 'A', number: 2, imageFile: 'a02.png', questionStartPct: 14.8, answerYPct: 19.5, explanationEndPct: 80.7, topic: '火力', parts: [{ correct: 5, points: 5 }] },
    { id: 'r7-1_a03', section: 'A', number: 3, imageFile: 'a03.png', questionStartPct: 14.2, answerYPct: 20.6, explanationEndPct: 81.2, topic: '火力', parts: [{ correct: 5, points: 5 }] },
    { id: 'r7-1_a04', section: 'A', number: 4, imageFile: 'a04.png', questionStartPct: 16.7, answerYPct: 33.1, explanationEndPct: 77.8, topic: '原子力', parts: [{ correct: 1, points: 5 }] },
    ...
    { id: 'r7-1_a06', section: 'A', number: 6, imageFile: 'a06.png', questionStartPct: 16.4, answerYPct: 27.3, explanationEndPct: 78.6, topic: '変電', parts: [{ correct: 3, points: 5 }] },
    ...
    { id: 'r7-1_a08', section: 'A', number: 8, imageFile: 'a08.png', questionStartPct: 15.0, answerYPct: 25.5, explanationEndPct: 80.5, topic: '送電', parts: [{ correct: 2, points: 5 }] },
    { id: 'r7-1_a09', section: 'A', number: 9, imageFile: 'a09.png', questionStartPct: 14.8, answerYPct: 28.5, explanationEndPct: 80.6, topic: '送電', parts: [{ correct: 3, points: 5 }] },
    { id: 'r7-1_a10', section: 'A', number: 10, imageFile: 'a10.png', questionStartPct: 15.5, answerYPct: 28.8, explanationEndPct: 79.9, topic: '送電', parts: [{ correct: 2, points: 5 }] },
    { id: 'r7-1_a11', section: 'A', number: 11, imageFile: 'a11.png', questionStartPct: 19.0, answerYPct: 28.8, explanationEndPct: 75.3, topic: '配電', parts: [{ correct: 3, points: 5 }] },
    ...
    { id: 'r7-1_a13', section: 'A', number: 13, imageFile: 'a13.png', questionStartPct: 21.0, answerYPct: 27.9, explanationEndPct: 72.8, topic: '配電', parts: [{ correct: 2, points: 5 }] },
